...
/*
IKRS.Girih.TILE_ALIGN[ IKRS.Girih.TILE_TYPE_DECAGON ][0] = Array(5);
IKRS.Girih.TILE_ALIGN[ IKRS.Girih.TILE_TYPE_DECAGON ][0][IKRS.Girih.TILE_TYPE_BOW_TIE] = [
    new IKRS.TileAlign( IKRS.Girih.DEFAULT_EDGE_LENGTH, new IKRS.Point2( 33, -100), 0 ),
    new IKRS.TileAlign( IKRS.Girih.DEFAULT_EDGE_LENGTH, new IKRS.Point2( 86, -62), 2*IKRS.Girih.MINIMAL_ANGLE ),
    new IKRS.TileAlign( IKRS.Girih.DEFAULT_EDGE_LENGTH, new IKRS.Point2( 86, -115), 6*IKRS.Girih.MINIMAL_ANGLE )
